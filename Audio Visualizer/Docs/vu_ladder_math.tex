...
\section*{One transistor, two resistors per LED}

Each stage is an NPN with a grounded emitter and an LED on the collector. Its
base divider decides when it turns on:
\begin{equation}
...
LED, and it caps each divider at about a milliamp at full scale. Each $R_k$
rounds to the nearest E24 value. Worst snap error is 3.8\%; adjacent
thresholds are 33\% apart, so the turn-on order never flips:

\begin{center}
\begin{tabular}{c r r r r}
\toprule
LED & $L_k$ & $R_k$ (E24) & threshold & snap error \\
\midrule
1  & $-22.5$\,dB & $47\kO$   & 0.79\,V  & $+0.1\%$ \\
2  & $-20.0$\,dB & $16\kO$   & 1.06\,V  & $+0.6\%$ \\
3  & $-17.5$\,dB & $9.1\kO$  & 1.36\,V  & $-2.6\%$ \\
4  & $-15.0$\,dB & $5.1\kO$  & 1.93\,V  & $+3.1\%$ \\
5  & $-12.5$\,dB & $3.6\kO$  & 2.46\,V  & $-1.4\%$ \\
6  & $-10.0$\,dB & $2.4\kO$  & 3.36\,V  & $+1.1\%$ \\
7  & $-7.5$\,dB  & $1.8\kO$  & 4.26\,V  & $-3.8\%$ \\
8  & $-5.0$\,dB  & $1.2\kO$  & 6.07\,V  & $+2.8\%$ \\
9  & $-2.5$\,dB  & $910\,\Omega$ & 7.79\,V & $-1.0\%$ \\
10 & $0.0$\,dB   & $680\,\Omega$ & 10.21\,V & $-2.8\%$ \\
\bottomrule
\end{tabular}
\end{center}
